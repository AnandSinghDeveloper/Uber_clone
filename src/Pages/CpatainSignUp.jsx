  ...
  return (
    <div className=" p-7 h-screen flex justify-between flex-col ">
      <div>
        <img
          className=" w-20 mb-7"
          src="http://pngimg.com/uploads/uber/uber_PNG24.png"
          alt=""
        />
        <form
          onSubmit={(e) => {
      ...
      <div className="pb-3 mt-7">
        <p className="text-xs ">
          This site is Protected bt CAPTCHA and the ,{" "}
          <span className=" underline font-medium ">Google Privcy Policy</span>{" "}
          and{" "}
          <span className=" underline font-medium ">
            Terams and Service Apply
          </span>
        </p>
      </div>
    </div>
