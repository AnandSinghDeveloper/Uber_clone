    ...
    <div className=" h-screen overflow-hidden">
      ...
      <div className="h-screen w-screen bg-yellow-400  p-3 rounded-tr-lg rounded-tl-lg z-10 ">
        <div
          ...
          className=" flex justify-center  rotate-0  "
        >
          {" "}
          <RiArrowUpWideFill
            style={{ width: "30px", height: "30px", color: "zinc" }}
          />{" "}
        </div>
        <div className=" flex justify-between items-center  ">
          ...
          <button
            ...
            className=" w-[50%] bg-green-600 p-2 rounded-lg text-white font-semibold mt-4 capitalize"
          >
            {" "}
            complete ride
          </button>
