...
const CaptainHome = () => {
  ...
  return (
    ...
    <div ref={confimRidePanalref} className=' fixed w-full z-10 bg-white h-screen  px-3 pt-[0.5rem] pb-6 bottom-0 translate-y-full  rounded-tr-lg rounded-tl-lg'>
             <ConfirmRidepopUp setRidePopUp={setRidePopUp} setConfimRidePanal={setConfimRidePanal} setCaptainRideing={setCaptainRideing} />
      </div>
      <div ref={captainRideingref} className=' fixed w-full z-10 bg-white h-screen  bottom-0 translate-y-full'>
             <CaptainRideing setCaptainRideing={setCaptainRideing} setConfimRidePanal={setConfimRidePanal}/>
      </div>
  </div>
  )
}
