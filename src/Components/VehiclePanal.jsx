...
const VehiclePanal = (props) => {
  return (
    <div>
      ...
      <h3 className=" capitalize text-2xl font-semibold mb-3">
        {" "}
        choose a vehicle
      </h3>
      <div
        onClick={() => {
          ...
          props.SelactVehicle("Car");
        }}
        className=" flex items-center  justify-between w-full mb-2 active:border-[3px] border-[3px] border-gray-200 active:border-black rounded-xl p-3  "
      >
        <img
          className=" h-14"
        ...
        <div className=" w-1/2">
          <h4 className=" font-semibold text-xl">
            {" "}
            UberGo{" "}
            <span className=" inline-block text-base ml-2">
              {" "}
              <FaUserLarge />{" "}
            </span>{" "}
        ...
        <h2 className=" font-semibold text-xl flex items-center text-green-700">
          {" "}
          <span className=" inline-block">
            {" "}
            <MdOutlineCurrencyRupee style={{ color: "green" }} />
          </span>
          {props.fare.Car}
        </h2>
      </div>
      ...
      <div className=" flex items-center  justify-between w-full mb-2 active:border-[3px] border-[3px] border-gray-200 active:border-black  rounded-xl p-3  ">
        ...
        <div
          onClick={() => {
            props.setConfirmRidePanal(true);
            props.SelactVehicle("Motorcycle");
          }}
          className=" w-1/2"
        >
          <h4 className=" font-semibold text-xl">
