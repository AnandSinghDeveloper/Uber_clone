...
const Riding = () => {
  return (
    <div className=' h-screen'>
      <Link to='/HomeScreen' className=' flex absolute right-2 top-2  w-14 h-14 items-center justify-center bg-white rounded-full '>
      ...
      <div className=' w-full p-2 flex flex-col justify-between '>
          <div className=' flex justify-between p-4'>
              ...
              <div className='w-full h-2 '>
                       <button className='w-full bg-green-600 p-2 rounded-lg text-white mt-[12vh] font-semibold capitalize'> make a payment</button> 
                       </div>  
      </div>
    </div>
  )
