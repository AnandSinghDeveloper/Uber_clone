  ...
  return (
    <div className=" h-2/5 w-full p-5 flex flex-col  justify-evenly  ">
      <div className=" flex justify-between items-center p-3 ">
        <div className="  relative h-16">
          <div className=" w-10 h-10 flex items-center ">
            <img
              ...
              src="https://t3.ftcdn.net/jpg/03/05/77/64/360_F_305776453_t7SUl48g63zLsyODxd60aj6EcWR9avVK.jpg"
              alt=""
            />
            <div>
        ...
        <div className=" ">
          <h2 className=" capitalize -mb-1 text-lg font-medium text-green-600">
          ...
          <p className=" capitalize ml-3 -mt-1 text-sm text-gray-400 ">
            earned
          </p>
        </div>
      </div>
      <div className=" h-28 mb-8 w-full rounded-xl flex justify-evenly items-center  bg-gray-100">
        <div className="text-center ">
          ...
          <p className=" font-light text-sm text-gray-400 capitalize">
            {" "}
            hours online{" "}
          </p>
        </div>
